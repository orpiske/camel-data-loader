...
import net.orpiske.camel.dataloader.data.ingestion.sink.entities.Mapping;
import net.orpiske.camel.dataloader.data.ingestion.sink.repository.MappingRepository;
